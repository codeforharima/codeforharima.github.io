...
Category: history
Tags: 2024
Summary: 稲美町探求学習でのOSM共有、デジタル技術実証募集、YAMAP流域地図、選挙ポスターOD要望
lang: ja
Slug: 202405
---
...
- ワードデータはGoogle Driveに保存
    - <https://drive.google.com/drive/folders/1pR1_A6bpLa1gUVBQDkUoGtZbDDmLuHek>
        - まだ全然見れてないです
    - 見た感じ写真が小さくて使えるか難しいかも
        - 小さな写真でプロトタイプを作ってみるしかないかも
    - 稲美町の東播磨高校では、探求学習の題材にため池を調べるっていう課題が出たが、調べても何も出てこない、この本を学校に置きたい。
...
- 18日10時からの番組「Fine Day！」
    - <https://www.banban.jp/radio/pickup/2024/05/000506.html>
...
- 高砂市に「選挙ポスター掲示板の場所をオープンデータにしてください」とお願いした
    - 回答としては「検討中」とのこと
    - でも、公開型GIS上で公開
        - <https://www2.wagmap.jp/takasago/PositionSelect?mid=55>
    - 候補者は、もらっていた
        - データの位置が微妙にずれている
    - 欲しかったのは生の位置情報、CSVデータ
        - 公開型GISのQRコードですべて渡された
        - そっちのほうが手間じゃない？
        - そうじゃない、ことが職員に伝わらない
            - コンピューターリテラシー？
...
- <https://event.ospn.jp/osc2024-do/>
    - 日程:2024年6月29日(土)10:00～18:00（展示は16:00まで）
    - 会場:札幌市産業振興センター 産業振興棟 2F ルームA(OSC受付)
    - 費用:無料
    - 内容:オープンソースに関する最新情報の提供オープンソースコミュニティ、企業・団体による展示
    - 主催:オープンソースカンファレンス実行委員会
    - 協力:一般財団法人さっぽろ産業振興財団一般社団法人LOCAL
    - 運営:株式会社びぎねっと
- 福田さんが行くそうです
    - [神戸空港](https://www.kairport.co.jp/)から[スカイマーク](https://www.skymark.co.jp/ja/)が安いですよ
