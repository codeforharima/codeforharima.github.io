...
Category: minutes
Tags: 2023
Summary: IODD2023参加、むこうじまフェスタ出展準備、兵庫大学OSM連携、ストロリー×OSMイベント
lang: ja
Slug: 202303
...
## 後半1時間はオープンデータデイのイベントです

- <https://opendataday.org/ja/>
- 世界で170のイベントが開催されます！
- Code for Harima　はまだ登録が反映されていないようです…

## ニューメディア推進協議会にて石本さん発表
...
- 音の出ないモニター、ブルートゥーススピーカー、机２、椅子２〜４、レジャーシート、座布団持っていきます（水野）
- 高砂市の自転車事故をQGISで可視化してみたので展示
    - データを見てみると、夕方に市役所以西の県道明石高砂線において事故が起こっている
...
![ブース配置図](202303-ishimoto.webp)

- 高砂市がQGIS使いたくなったら筒井さんが地域情報化アドバイザーとして訪問可能

## One by one　の補助事業として防災マッピングパーティー（福田）

- NPO法人[One by one](http://www.iimati.com/t162onebyone.html)の活動で、令和5年度に2つの補助金を獲得した
- 防災に特化したニューメディア協議会
...
- covid19ダッシュボード <https://www.stopcovid19.jp/>
