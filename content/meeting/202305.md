...
Category: meeting
Tags: 2023
Summary: 活動5周年、NotionでのWebサイト公開、Instagram開設、ドメイン・サイト整備の議論
lang: ja
Slug: 202305
---

- 日時: 2023/5/10（水）19:00-21:00
...
- 司会: 野方
- 参加者: 福田、高野、石本、畑、水野、坂ノ下
- リモート:
- 次回開催: 2023年6月14日（水）19:00-21:00
    - 開催場所: びぃぷらす
- Webサイト
...
- HackMDはどうするの？
    ...
    - 議事録が書き終わったらCtrl+Aで全選択してコピー、そしてNotionに貼り付ければ公開できます
- ページ公開の仕方
    - 新規+ボタンを押す
...
- NotionでWebサイトを作成しましたが、悩みが2つほどあるので相談
...
## Code for Japan　の活動レポートに加古川の記事

- <https://www.code4japan.org/news/event-20230311-decidim>
    - いつの間に…
    - 福田さんは出席していました

## 兵庫大学

- コラボレーションの件、学生に説明を金曜4限が丁度いい
    - その辺はおいおい

## イベントそろそろしませんか？

- マッピングパーティとか検討してみてもいいかも

## 防災の話

- 防災系のイベントを11月ぐらい開催に向けて計画中
