...
Category: meeting
Tags: 2023
Summary: 稲美町ため池植物データ化プロジェクト始動、IODD2024でのオープンデータソン企画、Decidim全国初導入紹介
lang: ja
Slug: 202311
---
...
- ３月の１週目？に予定されているオープンデータデーにできればオープンデータソンを開催したい！
- マッピングとWikipedeiaも書きたいけれど、そこまでたどり着けるかどうか・・・
- 水野的には文化財系のどこかを歩きたい：希望ありますか？
    - ぜひ、若松さんの職場、稲美町の[水辺の里公園](https://www.town.hyogo-inami.lg.jp/0000000397.html)で、ため池植物の登録や成果発表などを実施しませんか？
    - 実現に向けて調整しましょう（^^）
    - 東播磨フィールドステーションにも連絡し、協力できないか
- 話が早い！

## アンケートご協力のお願い（京大・大前）

ご無沙汰しております。加古川市出身，現京都大学大学院情報学研究科（附属病院医療情報企画部）の大前です。

私たちのチームでは，意識不明で救急搬送された際，本人に代わって医療者が患者の財布にあるカードを鍵に医療情報を検索できるシステムの研究開発をしており，財布の中身等に関する調査を実施しています。5分未満で回答できる簡単なアンケートになりますので，調査にご協力いただけませんでしょうか？何卒よろしくお願いいたします。
...
- Code for Japan Summit 2023: <https://summit2023.code4japan.org/>
    - 11月25日(土) 13:00-18:00
    - 石本さんがチームグラレコで参加予定　（グラレコ担当セッション（予定））
...
### 令和6年度加古川市協働のまちづくり推進事業

中学卒業後のサポートが少なく、高校生で定時制や通信高校辞めてからの居場所がなく引きこもってしまう子がいたりするので居場所を作って欲しいとの保護者さんの声があったりするので来期はその辺りで申請しようと思います。個人的には河川敷のイベントよりも社会課題解決型をもっと活用して欲しいなーと思うので他のかたも是非ご活用くださいー！

- <https://www.city.kakogawa.lg.jp/soshikikarasagasu/shiminbu/kyoudou/kyodo/R6/41026.html>
...
- 姫路市・播磨圏域連携中枢都市圏オープンデータカタログサイト: <https://city.himeji.gkan.jp/gkan/>
    ...
    - [RSSのリンク](https://city.himeji.gkan.jp/gkan/feeds/dataset.atom)消してる。新着チェックされたくないんか?
        - ~~ワシ、もう姫路市議会議員に出馬するしかないんか…（錯乱~~
            - しちゃいましょう
                - しますかねー(笑)

## Pythonのfoliumがよかった(野方)

- [folium](https://python-visualization.github.io/folium/latest/)というのは、プログラミング言語Pythonから[leaflet.js](https://leafletjs.com/)の地図を作るライブラリです。大学でPythonを使う授業をやってます。それで使ったネタです。
    - foliumを使うと3行ぐらいプログラムを書くだけで地図が出て、あっという間にピンを立てたりする地図が作れるので良さそうです
    - 先日、QGISでデモをしたものに似せて、[姫路市の2022年交通事故の場所](https://web.pref.hyogo.lg.jp/kk26/johoseisaku/documents/traffic_accident2017-2022.xlsx)と国土数値情報の[土砂災害危険地域のshpファイル](https://nlftp.mlit.go.jp/ksj/gml/datalist/KsjTmplt-A26.html)を重ねて作った[デモ](https://nogajun.codeberg.page/)を置きました。何かに出展するときに使えるかも
- 稲美町の地図で使ってみる?
    - ぜひため池の植物を表示しましょう
...
- ろみひーさんの本職のサイト
    - balloonshop e-スマイル: <https://balloon-esmile.com/>
    - e-スマイル(@esmile_design): <https://www.instagram.com/esmile_design/>

## はりまCAPリバさんのイベント告知（若松）

- <https://harimacapriba.jimdofree.com/>

- ＣＡＰ（キャップ）とは、子どもたちがあらゆる暴力から身を守るための人権教育プログラムです。
- 2023年　おとな公開講座のご案内
    - とき　２０２３年１２月３日（日）13：30～15：30　受付13：15～
    - ところ　東播磨生活創造センター　かこむ　1F　講座研修室
    - 対象　子どもにかかわる方、関心のある大人　どなたでも
    - 参加費　５００円（現地にてお支払いください）
    - 定員　３０人

## 12月9日(土) NPO法人つなぐ手と手とののイベント
